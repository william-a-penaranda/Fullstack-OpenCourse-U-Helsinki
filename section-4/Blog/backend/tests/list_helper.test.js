...
describe('mostBlogs', () => {
  ...
  test('of list with multiple blog entries', () => {
...
describe('mostLikes', () => {
  test.only('of list with 0 blog entries', () => {
  ...
  test.only('of list with only 1 blog entry', () => {
  ...
  test.only('of list with multiple blog entries', () => {
